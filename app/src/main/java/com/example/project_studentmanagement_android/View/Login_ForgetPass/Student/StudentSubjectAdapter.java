...
public class StudentSubjectAdapter extends BaseAdapter {
    ...
    public StudentSubjectAdapter(Context context, int layout, List<Subject> lst) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       Holder holder = new Holder();
        if(convertView==null) {
            ...
            holder.txtNamesubject = (TextView) convertView.findViewById(R.id.txtStdSName);
            holder.txtNote = (TextView) convertView.findViewById(R.id.txtStdNSubject);
